    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-white via-blue-100 to-[#3186FF] bg-clip-text text-transparent">
      ...
      <section className="py-12 border-y border-border/40 bg-muted/20">
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl font-bold text-[#00B95C]">100%</div>
      ...
      <section className="py-16 container">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/prompts" className="text-primary hover:text-primary/80 text-sm font-medium transition-colors">
            View all →
          </Link>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {categories.map((cat) => (
            <Link
              ...
              className="p-4 rounded-lg border border-border/40 bg-card hover:border-primary/50 transition-all text-center group"
            >
      ...
      <section className="py-20 container">
        <div className="rounded-2xl bg-gradient-to-r from-blue-900/40 to-indigo-900/40 p-12 text-center border border-primary/20">
